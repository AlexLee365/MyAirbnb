...
- (void)layoutSubviews
{
    ...
    _titleLabel.frame = CGRectMake(18, _bottomBorder.fs_bottom-titleHeight-weekdayMargin, titleWidth,titleHeight);
...
//    a = @"";
    NSString *result = [NSString stringWithFormat:@"%@%@", text, @"월"];
